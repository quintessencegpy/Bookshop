        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="LoginServlet" method="post">
                    <input type="hidden" name="COMMAND" value="FICTION_LOGIN" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="SignUpServlet" method="post">
                    <input type="hidden" name="COMMAND" value="FICTION_SIGN_UP"/>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse center" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-title">
                ...
                <li class="active"><a href="${fictionLink}">Fiction</a></li>
...
<section>
    <div class="container">
        <div class="row animated fadeIn">
            <c:forEach var="tempBook" items="${FICTION_LIST}">
                ...
                <ul class="pagination">
                    ...
                    <c:if test="${PAGE_NOW_NUM != 1}">
                        <c:url var="previousLink" value="ShowBookDetailServlet">
                            <c:param name="FLAG" value="FICTION_PAGINATION"/>
