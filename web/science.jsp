        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="LoginServlet" method="post">
                    <input type="hidden" name="COMMAND" value="SCIENCE_LOGIN" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="SignUpServlet" method="post">
                    <input type="hidden" name="COMMAND" value="SCIENCE_SIGN_UP"/>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse center" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-title">
                ...
                <li class="active"><a href="${scienceLink}">Science</a></li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    </div>
...
<section>
    <div class="container">
        <div class="row animated fadeIn">
            <c:forEach var="tempBook" items="${SCIENCE_LIST}">
                ...
                <ul class="pagination">
                    ...
                    <c:if test="${PAGE_NOW_NUM != 1}">
                        <c:url var="previousLink" value="ShowBookDetailServlet">
                            <c:param name="FLAG" value="SCIENCE_PAGINATION"/>
